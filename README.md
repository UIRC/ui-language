...
## Интерфейсный шаг
Одношаговая форма записи соответствует одному циклу «дыхания» интерфейса или одному интерфейсному шагу.

![](images/uisl-step.png)
...
```
^['перевод из C в F°', 'перевод из F в C°'], ~ИсходноеЗначение, !Рассчитать −> ИтоговоеЗначение
```
...
```
~Значение −> РезультатВЦельсиях, РезультатФаренгейтах
```
